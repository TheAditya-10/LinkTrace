...
export function LoadingState({ label = 'Processing…' }: { label?: string }) {
  return (
    <div className="flex h-full min-h-[240px] w-full flex-col items-center justify-center gap-3 text-ink-500">
      <div className="motion-loading relative flex h-14 w-14 items-center justify-center">
...
export function SkeletonBlock({ className = '' }: { className?: string }) {
  return <div className={`motion-loading animate-pulse rounded-xl bg-base-border/70 ${className}`} />
}
